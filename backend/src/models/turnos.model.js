...
class Turno {
    ...
    static async guardarGoogleEvent(id_turno, google_event_id_paciente = null, google_event_id_profesional = null) {
        try {
            ...
            query = query.slice(0, -2); // 🔹 Eliminar la última coma sobrante
