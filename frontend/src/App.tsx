...
import TestGrid from "./components/test/Dashboard";
      ...
      <PayPalScriptProvider options={{ clientId: client_id_paypal }}>
        <Router>
          <Routes>
            ...
            <Route path="/dashboard/facturacion" element={<RutaProtegida> <DashboardFacturacion /> </RutaProtegida>} />
            ...
            <Route path="/pruebas" element={<TestGrid/>} />
          </Routes>
          {/*<WhatsAppButton /> */}
        </Router>
